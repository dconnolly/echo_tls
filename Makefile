...
equiv:
	proverif -lib primitives.pvl -lib format.pvl -lib key_schedule.pvl -lib secrecy_assumption_equiv.pvl -lib misc.pvl -lib client.pvl -lib client_ech.pvl -lib server.pvl main_equiv.pv
